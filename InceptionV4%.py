...
def fine_tune_cnn(model, train_data, validation_data):
    ...
    # Save the model.
    updated_model.save('InceptionV3_model.h5')
...
def main():
    ...
    # include_top=False signifie que la couche entièrement connectée (top layer) du modèle inceptionV3 ne sera pas incluse.
